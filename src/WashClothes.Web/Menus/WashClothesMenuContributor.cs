...
namespace WashClothes.Web.Menus;

public class WashClothesMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public WashClothesMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<WashClothesResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                WashClothesMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
